...
#ifndef FRYDOM_FRCATENARYFORCE_EE444_H
#define FRYDOM_FRCATENARYFORCE_EE444_H
...
namespace frydom {
   ...
   */
  class FrCatenaryForce_ee444 : public FrForce {

   private:

    FrCatenaryLine_ee444 *m_line; ///< The parent line
    FrCatenaryLine_ee444::LINE_SIDE m_line_side;   ///< The side of the line where the tension is applied
   ...
   public:
    ...
    FrCatenaryForce_ee444(const std::string &name,
                    FrBody *body,
                    FrCatenaryLine_ee444 *line,
