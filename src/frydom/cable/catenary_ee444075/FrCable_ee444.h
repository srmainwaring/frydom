...
#ifndef FRYDOM_FRCABLE_EE444_H
#define FRYDOM_FRCABLE_EE444_H
...
//        double m_breakingTension = 0;                       ///< breaking tension in N (for visualization purpose for now)
   ...
   public:
    ...
    FrCable_ee444(const std::shared_ptr<FrNode> &startingNode,
...
//        ~FrCable();
    ...
    virtual double GetUnstrainedLength() const;
