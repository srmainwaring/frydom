...
//    FrCable::~FrCable() = default;
  ...
  FrCable_ee444::FrCable_ee444(const std::shared_ptr<FrNode> &startingNode,
  ...
  void FrCable_ee444::Initialize() {}

  void FrCable_ee444::SetCableProperties(const std::shared_ptr<FrCableProperties> prop) {
    m_properties = prop;
  }

  std::shared_ptr<FrCableProperties> FrCable_ee444::GetCableProperties() const {
    return m_properties;
  }

  void FrCable_ee444::SetUnstrainedLength(double L) {
    m_unstrainedLength = L;
  }

  double FrCable_ee444::GetUnstrainedLength() const {
    return m_unstrainedLength;
  }


  void FrCable_ee444::SetStartingNode(const std::shared_ptr<FrNode> startingNode) {
    // TODO: permettre de re-attacher le cable a un autre noeud si elle etait deja attachee a un noeud
    m_startingNode = startingNode;
  }

  std::shared_ptr<FrNode> FrCable_ee444::GetStartingNode() const {
    return m_startingNode;
  }

  void FrCable_ee444::SetEndingNode(const std::shared_ptr<FrNode> endingNode) {
    // TODO: permettre de re-attacher le cable a un autre noeud si elle etait deja attachee a un noeud
    m_endingNode = endingNode;
  }

  std::shared_ptr<FrNode> FrCable_ee444::GetEndingNode() const {
    return m_endingNode;
  }
...
//    }
  ...
  void FrCable_ee444::SetUnrollingSpeed(double unrollingSpeed) {
    m_unrollingSpeed = unrollingSpeed;
  }

  double FrCable_ee444::GetUnrollingSpeed() const {
    return m_unrollingSpeed;
  }

  void FrCable_ee444::UpdateTime(double time) {
    m_time_step = time - m_time;
    m_time = time;
  }

  void FrCable_ee444::UpdateState() {
  ...
  double FrCable_ee444::GetStrainedLength() const {
    double cl = 0.;
    int n = 1000;
