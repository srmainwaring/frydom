...
void SetUpMorisonModel(FrOffshoreSystem *system, std::vector<std::shared_ptr<FrBody>> bodyList) {
  ...
  auto morisonModel1 = make_morison_model("morisonModel1", bodyList[0]);
  ...
  auto morisonModel2 = make_morison_model("morisonModel2", bodyList[1]);
  ...
  auto morisonModel3 = make_morison_model("morisonModel3", bodyList[2]);
  ...
  auto morisonModel4 = make_morison_model("morisonModel4", bodyList[3]);
  ...
  auto morisonModel5 = make_morison_model("morisonModel5", bodyList[4]);
  ...
  auto morisonModel6 = make_morison_model("morisonModel6", bodyList[5]);
