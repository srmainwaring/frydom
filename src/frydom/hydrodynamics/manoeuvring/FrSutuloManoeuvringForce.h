...
namespace frydom {
  ...
  class FrSutuloManoeuvringForce : public FrForce {
   ...
   public:
    ...
    void SetAddedMassCoefficient(double A22) { m_mu22 = A22; }

    double GetAddedMassCoefficient() const { return m_mu22; }
...
//    void SetManoeuvringCoefficients(std::vector<double> cy, std::vector<double> cn);
   ...
   private:
    ...
    double c_Xpp0, c_Xpp1;
    double c_Ypp0, c_Ypp1, c_Ypp2, c_Ypp3, c_Ypp4, c_Ypp5, c_Ypp6, c_Ypp7, c_Ypp8;
    double c_Npp0, c_Npp1, c_Npp2, c_Npp3, c_Npp4, c_Npp5, c_Npp6, c_Npp7, c_Npp8, c_Npp9;
