...
#ifndef FRYDOM_FRCATENARYLINE_EE444_H
#define FRYDOM_FRCATENARYLINE_EE444_H
...
namespace frydom {
  ...
  class FrCatenaryLine_ee444
      : public FrLoggable<FrOffshoreSystem>, public FrCable_ee444, public FrPhysicsItem, public FrCatenaryAssetOwner {
   ...
   private:
    ...
    std::shared_ptr<FrCatenaryForce_ee444> m_startingForce;   ///< Force applied by the catenary line to the body at the
    ///< starting node
    std::shared_ptr<FrCatenaryForce_ee444> m_endingForce;     ///< Force applied by the catenary line to the body at the
    ///< ending node
    //--------------------------------------------------------------------------------------------------------------
   ...
   public:
    ...
    FrCatenaryLine_ee444(const std::string &name,
    ...
    std::shared_ptr<FrCatenaryForce_ee444> GetStartingForce();

    /// Get the ending force of the line
    /// \return the ending force of the line
    std::shared_ptr<FrCatenaryForce_ee444> GetEndingForce();
    ...
    Position GetPositionInWorld(const double &s, FRAME_CONVENTION fc) const override {
      return GetNodePositionInWorld(s, fc);
    }

    double GetUnstretchedLength() const override { return GetUnstrainedLength(); }
...
#endif //FRYDOM_FRCATENARYLINE_EE444_H
